...
import { ArrowLeft, Sun, Moon, Monitor, Volume2 } from "lucide-react";
      ...
      <main className="mx-auto max-w-md space-y-8 p-6">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            {/* Reduced Motion */}
            <label className="flex items-center justify-between rounded-lg border border-gray-700 bg-gray-800 p-4">
              <div>
                <p className="font-medium text-gray-200">Reduced Motion</p>
              ...
              <input
                ...
                className="h-5 w-5 rounded border-gray-600 bg-gray-700 text-green-500 focus:ring-green-500 focus:ring-offset-gray-900"
              />
            </label>
          </div>
        </section>
        ...
        <section className="border-t border-gray-800 pt-8">
          ...
          <div className="rounded-lg border border-gray-700 bg-gray-800 p-4">
            <p className="font-medium text-gray-200">40Hz Auditory Therapy</p>
            <p className="mt-1 text-sm text-gray-500">Version 1.0.0</p>
            <p className="mt-3 text-sm text-gray-400">
              Based on scientific research demonstrating the potential benefits
              of 40Hz gamma entrainment for cognitive enhancement and neural
              health.
            </p>
          </div>
        </section>
